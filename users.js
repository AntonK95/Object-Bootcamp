...
variabel.filter(function(nyVariabel){
	return nyVariabel.keyValue === 'key';
}); 
*/


// För att filtrera efter landskod
let filterByCountry = users.filter(function(user) {
	return user.nat === 'FR';
...
// filterByGender
let filterByGenderMale = users.filter(function(maleUser) {
	return maleUser.name.title === 'Mr' ||
			maleUser.name.title === 'Monsieur';
});

console.log(filterByGenderMale);


let filterByGenderFemale = users.filter(function(femaleUser) {
	return femaleUser.name.title === 'Miss' || 
			femaleUser.name.title === 'Mademoiselle' || 
			femaleUser.name.title === 'Ms' || 
			femaleUser.name.title === 'Mrs' || 
			femaleUser.name.title === 'Madame';
});

console.log(filterByGenderFemale);


// listEmails 
let listEmails = users.map(function(userEmail) {
...
let newEmails = users.map(newEmail);
